...
It defines the trust configuration a consuming server keeps ({{issuer-trust}}) and two points at which it consumes the artifact {{ISSUANCE}} defines:
